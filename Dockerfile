...
# ENV CGO_ENABLED=0
ENV SRC_DIR=${HOME}/go/src/github.com/anothrnick/redis-poc/
...
ENTRYPOINT ["/go/src/github.com/anothrnick/redis-poc/api"]
...
COPY --from=builder /go/src/github.com/anothrnick/redis-poc/api /bin/api
